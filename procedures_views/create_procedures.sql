...
--  1. Crie uma stored procedure que retorne todos 
--  os usuários que são compradores.
...
-- 2. Crie uma stored procedure que insira um novo 
-- produto na tabela Product.
DELIMITER $$ 
...
END$$
--
-- 3. Crie uma stored procedure que atualize a 
-- quantidade de um produto com base no seu ID
DELIMITER $$ 
...
END$$
--
-- 4. Crie uma stored procedure que retorne o total 
-- de vendas para uma loja específica.
DELIMITER $$ 
...
END$$
--
-- 5. Crie uma stored procedure que liste todos os 
...
END$$
--
-- 6. Crie uma stored procedure que insira um novo 
-- comentário de um comprador para um produto.
...
END$$
--
-- 7. Crie uma stored procedure que retorne todos os pedidos 
-- feitos por um comprador específico.
SELECT * FROM orders;
...
END$$
--
-- 8. Crie uma stored procedure que cancele um pedido com 
-- base no número do pedido.
DELIMITER $$ 
...
END$$
--
-- 9. Crie uma stored procedure que retorne o total de itens 
...
END$$
--
-- 10.Crie uma stored procedure que liste todos os produtos 
-- em estoque em uma determinada loja.
DELIMITER $$ 
...
END$$
--
-- 11.Crie uma stored procedure que retorne o nome e a avaliação 
-- média de um produto específico.
DELIMITER $$ 
...
END$$
--
-- 12.Crie uma stored procedure que atualize o número de pontos 
-- de serviço de uma marca específica.
DELIMITER $$ 
...
END$$
--
-- 13.Crie uma stored procedure que liste todos os pedidos feitos 
-- com um determinado cartão de crédito.
DELIMITER $$ 
...
END$$
--
-- 14.Crie uma stored procedure que retorne o endereço de entrega 
